...
describe("Test User class", function () {
  beforeEach(async function () {
    await db.query("DELETE FROM messages_1");
    await db.query("DELETE FROM users_1");
  ...
  test("can update login timestamp", async function () {
    await db.query(
      "UPDATE users_1 SET last_login_at=NULL WHERE username='test'"
    );
...
describe("Test messages_1 part of User class", function () {
  beforeEach(async function () {
    await db.query("DELETE FROM messages_1");
    await db.query("DELETE FROM users_1");
    await db.query("ALTER SEQUENCE messages_1_id_seq RESTART WITH 1");
  ...
  test("can get messages_1 from user", async function () {
  ...
  test("can get messages_1 to user", async function () {
